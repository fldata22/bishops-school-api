...
class SessionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->module = Module::create(['name' => 'Loyalty', 'code' => 'L', 'topics' => ['Intro', 'Chapter 1']]);
    ...
    {
        Session::create(['class_id' => $this->class->id, 'module_id' => $this->module->id, 'teacher_id' => $this->teacher->id, 'date' => '2026-04-09', 'topic_index' => 0]);
    ...
    public function test_can_filter_sessions_by_class(): void
    {
        ...
        Session::create(['class_id' => $this->class->id, 'module_id' => $this->module->id, 'teacher_id' => $this->teacher->id, 'date' => '2026-04-09', 'topic_index' => 0]);
        Session::create(['class_id' => $other->id, 'module_id' => $this->module->id, 'teacher_id' => $this->teacher->id, 'date' => '2026-04-09', 'topic_index' => 0]);
    ...
    {
        $session = Session::create(['class_id' => $this->class->id, 'module_id' => $this->module->id, 'teacher_id' => $this->teacher->id, 'date' => '2026-04-09', 'topic_index' => 0]);
